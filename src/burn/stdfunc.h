...
{                                                                                         \
      ...
      else if ((i < ((sizeof(Name##InputList) / sizeof(Name##InputList[0]))+nComCount))&&nInputMacroEnabled)    \
         {                                                                                \
	        if (pii)                                                                      \
              {                                                                           \
...
{																		 \
	...
	else if ((i < ((sizeof(Info1) / sizeof(Info1[0]))+nComCount))&&nInputMacroEnabled) {       \
	if (pii) {															 \
