...
struct BurnDriver BurnDrvVFive = {
	...
	"V-Five\0", "No sound (sound MCU not dumped)", "Toaplan", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvGrindStormer = {
	...
	"Grind Stormer (set 1)\0", "No sound (sound MCU not dumped)", "Toaplan", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvGrindStormerA = {
	...
	"Grind Stormer (set 2)\0", "Alternate version, no sound (sound MCU not dumped)", "Toaplan GP9001 based", "Toaplan",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | TOA_ROTATE_GRAPHICS_CCW, 2, HARDWARE_TOAPLAN_68K_Zx80,
