...
static struct BurnRomInfo bbkraiduRomDesc[] = {
...
static int bbakraidInit()
{
	...
	if (strcmp("bbkraidu", BurnDrvGetTextA(DRV_NAME)) == 0) {
...
struct BurnDriver BurnDrvBattleBakraidU = {
	"bbkradu", "bbakraid", NULL, "1999",
	"Battle Bakraid (ver. Tue Jun 8 1999)\0", "Unlimited version", "Eighting", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | TOA_ROTATE_GRAPHICS_CCW, 2, HARDWARE_TOAPLAN_RAIZING,
	NULL, bbkraiduRomInfo, bbkraiduRomName, bbakraidInputInfo, bbakraidDIPInfo,
	bbakraidInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &ToaRecalcPalette,
	240, 320, 3, 4
};
