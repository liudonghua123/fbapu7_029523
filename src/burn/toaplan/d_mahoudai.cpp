...
struct BurnDriver BurnDrvMahouDai = {
	...
	"Mahou Daisakusen\0", "Japan region", "Raizing", "Toaplan GP9001 based",
	L"\u9B54\u6CD5\u5927\u4F5C\u6226\0Mahou Daisakusen\0", NULL, NULL, NULL,
...
struct BurnDriver BurnDrvSStriker = {
	...
	"Sorcer Striker (set 1)\0", NULL, "Raizing", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvSStrikrA = {
	...
	"Sorcer Striker (set 2)\0", "Alternate version", "Raizing", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | TOA_ROTATE_GRAPHICS_CCW, 2, HARDWARE_TOAPLAN_RAIZING,
