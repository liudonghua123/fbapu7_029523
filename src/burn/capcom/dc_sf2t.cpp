...
//=====================================
//Street Fighter II' C.E. (Turyu) Init
//=====================================
static int Sf2tloncInit()
{
	int nRet=0;
	Cps=1; Sf2Hack=1;
	nCpsRomLen =2*0x100000 + 2*0x020000;
	nCpsGfxLen =3*0x200000;
	nCpsZRomLen=  0x010000;
	nCpsAdLen  =2*0x020000;
...
//=======================================
//Street Fighter II' C.E. (rev. 1.3) Init
//=======================================
...
struct BurnDriver BurnDrvCpsSf2ce = {
	...
	"Street Fighter II' - champion edition (920313 World)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvCpsSf2cej = {
	...
	"Street Fighter II' - champion edition (920513 Japan)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvCpsSf2ceua = {
	...
	"Street Fighter II' - champion edition (920313 USA)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE,2,HARDWARE_CAPCOM_CPS1,
...
struct BurnDriver BurnDrvCpsSf2ceuc = {
	...
	"Street Fighter II' - champion edition (920803 USA)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE,2,HARDWARE_CAPCOM_CPS1,
...
struct BurnDriver BurnDrvCpsSf2accp2 = {
	...
	"Street Fighter II' - champion edition (Accelerator Pt.II)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvCpsSf2rb = {
	...
	"Street Fighter II' - champion edition (Rainbow set 1)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
...
struct BurnDriver BurnDrvCpsSf2rb2 = {
	...
	"Street Fighter II' - champion edition (Rainbow set 2)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
...
struct BurnDriver BurnDrvCpsSf2red = {
	...
	"Street Fighter II' - champion edition (Red Wave)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
...
struct BurnDriver BurnDrvCpsSf2v004 = {
	...
	"Street Fighter II' - champion edition (V004)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
...
//===========================================
//Street Fighter II' - Hyper Fighting (World)
//===========================================
...
struct BurnDriver BurnDrvCpsSf2hf = {
	...
	"Street Fighter II' - hyper fighting (921209 World)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING,2,HARDWARE_CAPCOM_CPS1,
...
struct BurnDriver BurnDrvCpsSf2t = {
	...
	"Street Fighter II' - hyper fighting (921209 USA)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE,2,HARDWARE_CAPCOM_CPS1,
...
struct BurnDriver BurnDrvCpsSf2tj = {
	...
	"Street Fighter II' Turbo - hyper fighting (921209 Japan)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE,2,HARDWARE_CAPCOM_CPS1,
...
struct BurnDriver BurnDrvCpsSf2yyc = {
	...
	"Street Fighter II' - champion edition (YYC)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
...
//===============================================================
//Street Fighter II' - champion edition (Subdue the Dragon, set 1)
//===============================================================
...
struct BurnDriver BurnDrvCpsKouryu = {
	...
	"Street Fighter II' - champion edition (Subdue the Dragon, set 1)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
...
//==================================================
//Street Fighter II' - Champion Edition (M-1 [Hack])
//==================================================

static struct BurnRomInfo sf2m1RomDesc[] = {
	{ "222e"         , 0x080000, 0x1e20d0a3, BRF_ESS | BRF_PRG }, // 0
	{ "196e"         , 0x080000, 0x88cc38a3, BRF_ESS | BRF_PRG }, // 1
...
//------------------------------------------------------------------------------------------------------------
	...
	// Load up and interleave each set of 4 roms to make the 16x16 tiles
	CpsLoadTiles(CpsGfx+0x000000, 3);
	CpsLoadTiles(CpsGfx+0x200000, 7);
	CpsLoadTiles(CpsGfx+0x400000,11);
...
struct BurnDriver BurnDrvCpssf2m1 = {
	...
	"Street Fighter II' - champion edition (M-1)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
        NULL,sf2m1RomInfo,sf2m1RomName,DrvInputInfo, sf2cejDIPInfo,
...
struct BurnDriver BurnDrvCpssf2m2 = {
	...
	"Street Fighter II' - champion edition (M-2)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
        NULL,sf2m2RomInfo,sf2m2RomName,Sf2yycInputInfo, sf2cejDIPInfo,
	sf2m2Init,DrvExit,Cps1Frame,CpsRedraw,CpsAreaScan,
	&CpsRecalcPal,384,224,4,3
};

//==================================================
//Street Fighter II' - Champion Edition (M-3 [Hack])
//==================================================

static struct BurnRomInfo sf2m3RomDesc[] = {
	{ "u222chp"      , 0x080000, 0xdb567b66, BRF_ESS | BRF_PRG }, // 0
	{ "u196chp"      , 0x080000, 0x95ea597e, BRF_ESS | BRF_PRG }, // 1
	{ "s92_21a.bin"  , 0x080000, 0x925a7877, BRF_ESS | BRF_PRG }, // 2
...
struct BurnDriver BurnDrvCpssf2m3 = {
	...
	"Street Fighter II' - champion edition (M-3)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
        NULL,sf2m3RomInfo,sf2m3RomName,Sf2yycInputInfo, sf2cejDIPInfo,
	DrvInit,DrvExit,Cps1Frame,CpsRedraw,CpsAreaScan,
	&CpsRecalcPal,384,224,4,3
};
...
struct BurnDriver BurnDrvCpsSf2m4 = {
	...
	"Street Fighter II' - champion edition (M-4)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
...
struct BurnDriver BurnDrvCpsSf2m5 = {
	...
	"Street Fighter II' - champion edition (M-5)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
...
struct BurnDriver BurnDrvCpsSf2m6 = {
	...
	"Street Fighter II' - champion edition (Subdue the Dragon, set 2)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
...
struct BurnDriver BurnDrvCpsSf2m7 = {
	...
	"Street Fighter II' - champion edition (M-7)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
...
//==================================================
//Street Fighter II' - champion edition (M-8 [Hack])
//==================================================

static struct BurnRomInfo Sf2m8RomDesc[] = {
	{ "k4-222",       0x080000, 0x1ca7adbd, BRF_ESS | BRF_PRG }, // 0
	{ "k4-196",       0x080000, 0xf758408c, BRF_ESS | BRF_PRG }, // 1
	{ "u221.epr",     0x020000, 0x720cea3e, BRF_ESS | BRF_PRG }, // 2
	{ "u195.epr",     0x020000, 0x9932832c, BRF_ESS | BRF_PRG }, // 3
...
struct BurnDriver BurnDrvCpsSf2m8 = {
	...
	"Street Fighter II' - champion edition (M-8)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
	NULL,Sf2m8RomInfo,Sf2m8RomName,Sf2yycInputInfo, sf2ceDIPInfo,
	DrvInit,DrvExit,Cps1Frame,CpsRedraw,CpsAreaScan,
	&CpsRecalcPal,384,224,4,3
};

//===================================================
//Street Fighter II' - champion edition (M-13 [Hack])
//===================================================

static struct BurnRomInfo Sf2m13RomDesc[] = {
	{ "222-040.13",   0x040000, 0x1ca7adbd, BRF_ESS | BRF_PRG }, // 0
	{ "196-040.13",   0x040000, 0xf758408c, BRF_ESS | BRF_PRG }, // 1
	{ "221-040.13",   0x040000, 0x720cea3e, BRF_ESS | BRF_PRG }, // 2
	{ "195-040.13",   0x040000, 0x9932832c, BRF_ESS | BRF_PRG }, // 3
...
struct BurnDriver BurnDrvCpsSf2m13 = {
	"sf2m13", "sf2ce", NULL, "1992",
	"Street Fighter II' - champion edition (M-13)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
	NULL,Sf2m13RomInfo,Sf2m13RomName,Sf2yycInputInfo, sf2ceDIPInfo,
	DrvInit,DrvExit,Cps1Frame,CpsRedraw,CpsAreaScan,
	&CpsRecalcPal,384,224,4,3
};

//==============================================================
//Street Fighter II' - Champion Edition (Slay the Dragon set 1)
//==============================================================

static struct BurnRomInfo sf2tlonaRomDesc[] = {
	{ "tl4mt.1"     , 0x080000, 0x158635ca, BRF_ESS | BRF_PRG }, // 0
	{ "tl4m.2"      , 0x080000, 0x882cd1c4, BRF_ESS | BRF_PRG }, // 1
	{ "u221t.1m"    , 0x020000, 0x1073b7b6, BRF_ESS | BRF_PRG }, // 2
	{ "u195t.1m"    , 0x020000, 0xdb7e1f72, BRF_ESS | BRF_PRG }, // 3
...
struct BurnDriver BurnDrvCpssf2tlona = {
	...
	"Street Fighter II' - champion edition (Slay the Dragon, set 1)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
        NULL,sf2tlonaRomInfo,sf2tlonaRomName,Sf2yycInputInfo, sf2ceDIPInfo,
	KouryuInit,DrvExit,Cps1Frame,CpsRedraw,CpsAreaScan,
	&CpsRecalcPal,384,224,4,3
};

//=============================================================
//Street Fighter II' - Champion Edition (Slay the Dragon set 2)
//=============================================================

static struct BurnRomInfo sf2tlonbRomDesc[] = {
	{ "tl4m.1"      , 0x080000, 0xafc7bd18, BRF_ESS | BRF_PRG }, // 0
	{ "tl4m.2"      , 0x080000, 0x882cd1c4, BRF_ESS | BRF_PRG }, // 1
	{ "u221.1m"     , 0x020000, 0xd1707134, BRF_ESS | BRF_PRG }, // 2
	{ "u195.1m"     , 0x020000, 0xcd1d5666, BRF_ESS | BRF_PRG }, // 3
...
struct BurnDriver BurnDrvCpssf2tlonb = {
	...
	"Street Fighter II' - champion edition (Slay the Dragon, set 2)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
        NULL,sf2tlonbRomInfo,sf2tlonbRomName,Sf2yycInputInfo, sf2ceDIPInfo,
	KouryuInit,DrvExit,Cps1Frame,CpsRedraw,CpsAreaScan,
	&CpsRecalcPal,384,224,4,3
};

//==============================================================
//Street Fighter II' - Champion Edition (Slay the Dragon, set 3)
//==============================================================

static struct BurnRomInfo Sf2tloncRomDesc[] = {
	{ "u222-f83.040" ,0x100000, 0x47468198, BRF_ESS | BRF_PRG }, // 0
	{ "u196-99d.040" ,0x100000, 0x47d34191, BRF_ESS | BRF_PRG }, // 1
	{ "u221-59e.010" ,0x040000, 0x5507bac9, BRF_ESS | BRF_PRG }, // 2
	{ "u195-472.010" ,0x040000, 0x7755a20a, BRF_ESS | BRF_PRG }, // 3
...
// Make The RomInfo/Name functions for the game
STD_ROM_PICK(Sf2tlonc) STD_ROM_FN(Sf2tlonc)

struct BurnDriver BurnDrvCpsSf2tlonc = {
	"sf2tlonc", "sf2ce", NULL, "1992",
	"Street Fighter II' - champion edition (Slay the Dragon, set 3)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
        NULL,Sf2tloncRomInfo,Sf2tloncRomName,Sf2yycInputInfo, sf2ceDIPInfo,
	Sf2tloncInit,DrvExit,Cps1Frame,CpsRedraw,CpsAreaScan,
	&CpsRecalcPal,384,224,4,3
};

//==============================================
//Street Fighter II' - Champion Edition (1.3)
//==============================================

static struct BurnRomInfo sfce13RomDesc[] = {
	{ "222-40.13"   , 0x080000, 0xec6f5cb3, BRF_ESS | BRF_PRG }, // 0
	{ "196-40.13"   , 0x080000, 0x0e9ac52b, BRF_ESS | BRF_PRG }, // 1
...
struct BurnDriver BurnDrvCpssfce13 = {
	...
	"Street Fighter II' - champion edition (sfce13)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
...
//========================================================
//Street Fighter II' - champion edition (Hispanic) [Hack]
//=======================================================


static struct BurnRomInfo Sf2cehRomDesc[] = {
	{ "sf2ceh.23",     0x80000, 0x25dc14c8, BRF_ESS | BRF_PRG }, //  0 68000 code
	{ "sf2ceh.22",     0x80000, 0x1c9dd91c, BRF_ESS | BRF_PRG }, //  1
	{ "s92_21a.bin",   0x80000, 0x925a7877, BRF_ESS | BRF_PRG }, //  2
...
struct BurnDriver BurnDrvCpsSf2ceh = {
	...
	"Street Fighter II' - champion edition (990804 Hispanic)\0", "Hack / Included in MAME Plus!", "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG,2,HARDWARE_CAPCOM_CPS1,
	NULL,Sf2cehRomInfo,Sf2cehRomName,DrvInputInfo, sf2ceDIPInfo,
	DrvInit,DrvExit,Cps1Frame,CpsRedraw,CpsAreaScan,
	&CpsRecalcPal,384,224,4,3
};
