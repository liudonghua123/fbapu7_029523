...
//================================
//Super Puzzle Fighter 2 X (Japan)
//================================


static struct BurnRomInfo Spf2xjRomDesc[] = {
	{ "pzfjx.03a",     0x80000, 0xc2e3f231, 2 | BRF_ESS },
...
struct BurnDriver BurnDrvCpsSpf2xj = {
	...
	"Super Puzzle Fighter II X (960531 Japan)\0", NULL, "Capcom", "CPS2",
	NULL, NULL, NULL, NULL,
...
static struct BurnRomInfo Spf2tRomDesc[] = {
	{ "pzfux.03a",     0x80000, 0x200feea6, 2 | BRF_ESS },
...
struct BurnDriver BurnDrvCpsSpf2t = {
	...
	"Super Puzzle Fighter II Turbo (960620 USA)\0", NULL, "Capcom", "CPS2",
	NULL, NULL, NULL, NULL,
...
//==================================
//Super Puzzle Fighter 2 Turbo (Asia)
//==================================


static struct BurnRomInfo Spf2taRomDesc[] = {
	{ "pzfax.03a",	  0x80000,  0x7d29dd83, 2 | BRF_ESS },

	{ "pzfa.03a",	    0x80000,  0x3cecfa78, 1 | BRF_ESS | BRF_PRG },
	{ "pzf.04",	      0x80000,  0xb80649e2, 1 | BRF_ESS | BRF_PRG },
...
struct BurnDriver BurnDrvCpsSpf2ta = {
	...
	"Super Puzzle Fighter II Turbo (960529 Asia)\0", NULL, "Capcom", "CPS2",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE,2,HARDWARE_CAPCOM_CPS2,
