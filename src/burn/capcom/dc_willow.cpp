...
struct BurnDriver BurnDrvCpsWillow = {
	...
	"Willow (USA)\0", "US region", "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvCpsWillowje = {
	...
	"Willow (Japan, English)\0", "Japan region, English language", "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvCpsWillowj = {
	...
	"Willow (Japan, Japanese)\0", "Japan region, Japanese language", "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE,2,HARDWARE_CAPCOM_CPS1,
