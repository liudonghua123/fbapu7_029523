...
static struct BurnRomInfo VampjRomDesc[] = {
	{ "vamjx.03a",     0x80000, 0x2549f7bc, 2 | BRF_ESS },
	{ "vamjx.04b",     0x80000, 0xbb5a30a5, 2 | BRF_ESS },
...
struct BurnDriver BurnDrvCpsVampj = {
	...
	"Vampire - the night warriors (940705 Japan set 1)\0", NULL, "Capcom", "CPS2",
	NULL, NULL, NULL, NULL,
...
static struct BurnRomInfo VampjaRomDesc[] = {
	{ "vamjx.03a",     0x80000, 0x2549f7bc, 2 | BRF_ESS },
	{ "vamjx.04a",     0x80000, 0xfe64a5cf, 2 | BRF_ESS },
...
struct BurnDriver BurnDrvCpsVampja = {
	...
	"Vampire - the night warriors (940705 Japan set 2)\0", "Alternate version", "Capcom", "CPS2",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE,2,HARDWARE_CAPCOM_CPS2,
...
static struct BurnRomInfo Vampjr1RomDesc[] = {
	{ "vamjx.03",      0x80000, 0xf6fe646a, 2 | BRF_ESS },
	{ "vamjx.04",      0x80000, 0x566014e5, 2 | BRF_ESS },
...
static struct BurnRomInfo DstlkRomDesc[] = {
	{ "vamex.03a",     0x80000, 0x2d1e4919, 2 | BRF_ESS },
	{ "vamex.04a",     0x80000, 0xe5172837, 2 | BRF_ESS },
...
static struct BurnRomInfo DstlkuRomDesc[] = {
	{ "vamux.03b",     0x80000, 0x15ff2d3e, 2 | BRF_ESS },
	{ "vamux.04b",     0x80000, 0x4cf62f1b, 2 | BRF_ESS },
...
static struct BurnRomInfo Dstlkur1RomDesc[] = {
	{ "vamux.03a",     0x80000, 0xdb0837f5, 2 | BRF_ESS },
	{ "vamux.04a",     0x80000, 0x8a924055, 2 | BRF_ESS },
...
static struct BurnRomInfo DstlkaRomDesc[] = {
	{ "vamax.03a",     0x80000, 0x9b7d6254, 2 | BRF_ESS },
	{ "vamax.04a",     0x80000, 0xd9ec3a82, 2 | BRF_ESS },
