...
static struct BurnRomInfo DdtodRomDesc[] = {
	{ "dadex.03c",     0x80000, 0x7b8b9b2c, 2 | BRF_ESS },			 // xor decryption tables
	{ "dadex.04c",     0x80000, 0x370626d3, 2 | BRF_ESS },
	{ "dadex.05c",     0x80000, 0x5fd29e95, 2 | BRF_ESS },
...
static struct BurnRomInfo DdtoduRomDesc[] = {
	{ "dadux.03b",     0x80000, 0xf59ee70c, 2 | BRF_ESS },			 // xor decryption tables
	{ "dadux.04b",     0x80000, 0x622628ae, 2 | BRF_ESS },
	{ "dadux.05b",     0x80000, 0x424bd6e3, 2 | BRF_ESS },
...
static struct BurnRomInfo Ddtodur1RomDesc[] = {
	{ "dadux.03a",     0x80000, 0xf9ba14b6, 2 | BRF_ESS },			 // xor decryption tables
	{ "dadux.04a",     0x80000, 0xed85ec29, 2 | BRF_ESS },
	{ "dadux.05a",     0x80000, 0xdbae3d1b, 2 | BRF_ESS },
...
static struct BurnRomInfo DdtodjRomDesc[] = {
	{ "dadjx.03b",     0x80000, 0x590f7591, 2 | BRF_ESS },			 // xor decryption tables
	{ "dadjx.04b",     0x80000, 0x3735c834, 2 | BRF_ESS },
	{ "dadjx.05b",     0x80000, 0xb0a2a913, 2 | BRF_ESS },
...
/*=============================
 D&D - tower of doom (Japan r1)
=============================*/


static struct BurnRomInfo Ddtodjr1RomDesc[] = {
	{ "dadjx.03a",     0x80000, 0x4c7334d3, 2 | BRF_ESS },			 // xor decryption tables
	{ "dadjx.04a",     0x80000, 0xcfd15109, 2 | BRF_ESS },
	{ "dadjx.05a",     0x80000, 0xd23bcd71, 2 | BRF_ESS },
...
static struct BurnRomInfo DdtodaRomDesc[] = {
	{ "dadax.03a",     0x80000, 0x00000000, 2 | BRF_ESS },			 // xor decryption tables
	{ "dadax.04a",     0x80000, 0x00000000, 2 | BRF_ESS },
	{ "dadax.05a",     0x80000, 0x00000000, 2 | BRF_ESS },
...
struct BurnDriver BurnDrvCpsDdtoda = {
	...
	"Dungeons & Dragons - tower of doom (940113 Asia)\0", "Encrypted", "Capcom", "CPS2",
	NULL, NULL, NULL, NULL,
	BDF_CLONE,4,HARDWARE_CAPCOM_CPS2,
...
static struct BurnRomInfo DdtodhRomDesc[] = {
	{ "dadhx.03b",     0x80000, 0xb9a16065, 2 | BRF_ESS },			 // xor decryption tables
	{ "dadhx.04b",     0x80000, 0x6b0d5086, 2 | BRF_ESS },
	{ "dadhx.05b",     0x80000, 0xe01ee2b2, 2 | BRF_ESS },
