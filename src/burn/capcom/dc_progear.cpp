...
static struct BurnRomInfo progearRomDesc[] = {
	{ "pgaux.03",     0x080000, 0xFD58616B,  2 | BRF_ESS },
	{ "pgaux.04",     0x080000, 0x6081A891,  2 | BRF_ESS },
...
static struct BurnRomInfo progearaRomDesc[] = {
	{ "pgaax.03",     0x080000, 0x00000000,  2 | BRF_ESS },
	{ "pgaax.04",     0x080000, 0x00000000,  2 | BRF_ESS },
...
struct BurnDriver BurnDrvCpsProgeara = {
	...
	NULL, NULL, NULL, NULL,
	BDF_CLONE, 2, HARDWARE_CAPCOM_CPS2 | HARDWARE_CAPCOM_CPS2_SIMM,
...
/*========================
 Progear no arashi (Japan)
========================*/

static struct BurnRomInfo progearjRomDesc[] = {
	{ "pgajx.03",     0x080000, 0xB44E4BCF,  2 | BRF_ESS },
	{ "pgajx.04",     0x080000, 0x354DB29D,  2 | BRF_ESS },
