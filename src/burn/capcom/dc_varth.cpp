...
struct BurnDriver BurnDrvCpsVarth = {
	...
	"Varth - operation thunderstorm (920714 World)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
...
// ===================================================
// Varth - Operation Thunderstorm (World [revision 1])
// ===================================================
...
struct BurnDriver BurnDrvCpsvarthr1 = {
	...
	"Varth - operation thunderstorm (920612 World)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
