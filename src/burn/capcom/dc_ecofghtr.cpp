...
static struct BurnRomInfo EcofghtrRomDesc[] = {
	{ "uecex.03",      0x80000, 0xe0ff3d51, 2 | BRF_ESS },
	{ "uecex.04",      0x80000, 0xb9f998e8, 2 | BRF_ESS },
	{ "uecex.05",      0x80000, 0x12410260, 2 | BRF_ESS },
	{ "uecex.06",      0x80000, 0xd5b4b1a2, 2 | BRF_ESS },
...
struct BurnDriver BurnDrvCpsEcofghtr = {
	...
	"Eco Fighters (931203 World)\0", NULL, "Capcom", "CPS2",
	NULL, NULL, NULL, NULL,
...
static struct BurnRomInfo UecologyRomDesc[] = {
	{ "uecjx.03",      0x80000, 0x00000000, 2 | BRF_ESS },
	{ "uecjx.04",      0x80000, 0x00000000, 2 | BRF_ESS },
	{ "uecjx.05",      0x80000, 0x00000000, 2 | BRF_ESS },
	{ "uecjx.06",      0x80000, 0x00000000, 2 | BRF_ESS },
...
struct BurnDriver BurnDrvCpsUecology = {
	...
	"Ultimate Ecology (931203 Japan)\0", "Encrypted", "Capcom", "CPS2",
	NULL, NULL, NULL, NULL,
...
static struct BurnRomInfo EcofghtaRomDesc[] = {
	{ "uecax.03",	  0x80000,  0x00000000, 2 | BRF_ESS },
	{ "uecax.04",	  0x80000,  0x00000000, 2 | BRF_ESS },
	{ "uecax.05",	  0x80000,  0x00000000, 2 | BRF_ESS },
	{ "uecax.06",	  0x80000,  0x00000000, 2 | BRF_ESS },
...
struct BurnDriver BurnDrvCpsEcofghta = {
	...
	"Eco Fighters (931203 Asia)\0", "Encrypted", "Capcom", "CPS2",
	NULL, NULL, NULL, NULL,
	BDF_CLONE,2,HARDWARE_CAPCOM_CPS2,
