...
static struct BurnRomInfo BatcirjRomDesc[] = {
	{ "btcjx.03",      0x80000, 0x01482d08, 2 | BRF_ESS },
	{ "btcjx.04",      0x80000, 0x3d4c976b, 2 | BRF_ESS },
	{ "btcjx.05",      0x80000, 0x5bf819e1, 2 | BRF_ESS },
	{ "btcjx.06",      0x80000, 0x5d2fd190, 2 | BRF_ESS },
...
struct BurnDriver BurnDrvCpsBatcirj = {
	...
	"Battle Circuit (970319 Japan)\0", "", "Capcom", "CPS2",
	NULL, NULL, NULL, NULL,
...
/*===============================
 Battle Circuit (Asia) Encrypted
===============================*/


static struct BurnRomInfo BatciraRomDesc[] = {
	{ "btcax.03",      0x80000, 0x00000000, 2 | BRF_ESS },
	{ "btcax.04",      0x80000, 0x00000000, 2 | BRF_ESS },
	{ "btcax.05",      0x80000, 0x00000000, 2 | BRF_ESS },
	{ "btcax.06",      0x80000, 0x00000000, 2 | BRF_ESS },
...
struct BurnDriver BurnDrvCpsBatcira = {
	...
	"Battle Circuit (970319 Asia)\0", "Encrypted", "Capcom", "CPS2",
	NULL, NULL, NULL, NULL,
...
static struct BurnRomInfo BatcirRomDesc[] = {
	{ "btcex.03",      0x80000, 0x2d193cd0, 2 | BRF_ESS },
	{ "btcex.04",      0x80000, 0xa3895d8b, 2 | BRF_ESS },
	{ "btcex.05",      0x80000, 0xbdbed16f, 2 | BRF_ESS },
	{ "btcex.06",      0x80000, 0x02048217, 2 | BRF_ESS },
