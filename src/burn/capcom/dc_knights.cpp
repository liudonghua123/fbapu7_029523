...
struct BurnDriver BurnDrvCpsKnights = {
	...
	"Knights of the Round (911127 World)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvCpsKnightsh = {
	...
	"Knights of the Round (Hack)\0", NULL, "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
...
static struct BurnRomInfo KnightsbRomDesc[] = {
	{ "040-z.02",      0x80000, 0x95d00a7e, BRF_ESS | BRF_PRG },
	{ "040-r.02",      0x80000, 0x5a9d0b64, BRF_ESS | BRF_PRG },
...
struct BurnDriver BurnDrvCpsKnightsb = {
	...
	"Knights of the Round (bootleg)\0", "Bad GFX", "Capcom", "CPS1",
	NULL, NULL, NULL, NULL,
	BDF_CLONE | BDF_BOOTLEG,3,HARDWARE_CAPCOM_CPS1,
	NULL,KnightsbRomInfo,KnightsbRomName,DrvInputInfo, knightsDIPInfo,
