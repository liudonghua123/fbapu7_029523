...
static struct BurnRomInfo espradeRomDesc[] = {
	{ "u42_i.bin",    0x080000, 0x3B510A73, BRF_ESS | BRF_PRG }, //  0 CPU #0 code
	{ "u41_i.bin",    0x080000, 0x97C1B649, BRF_ESS | BRF_PRG }, //  1
...
static struct BurnRomInfo espradejRomDesc[] = {
	{ "u42_ver2.bin", 0x080000, 0x75D03C42, BRF_ESS | BRF_PRG }, //  0 CPU #0 code
	{ "u41_ver2.bin", 0x080000, 0x734B3EF0, BRF_ESS | BRF_PRG }, //  1
...
struct BurnDriver BurnDrvEspradej = {
	...
	"ESP Ra.De. (1998 4/21 master ver.)\0", "Japan region", "Atlus / Cave", "Cave",
	L"ESP Ra.De. (1998 4/21 master ver.)\0\u30A8\u30B9\u30D7\u30EC\u30A4\u30C9\0", NULL, NULL, NULL,
...
struct BurnDriver BurnDrvEspradeo = {
	...
	"ESP Ra.De. (1998 4/14 master ver.)\0", "Japan region", "Atlus / Cave", "Cave",
	L"ESP Ra.De. (1998 4/14 master ver.)\0\u30A8\u30B9\u30D7\u30EC\u30A4\u30C9\0", NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_16BIT_ONLY, 2, HARDWARE_CAVE_68K_ONLY,
