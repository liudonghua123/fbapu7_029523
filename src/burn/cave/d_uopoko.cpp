...
static struct BurnRomInfo uopokoRomDesc[] = {
	{ "u26j.bin",     0x080000, 0xE7EEC050, BRF_ESS | BRF_PRG }, //  0 CPU #0 code
	{ "u25j.bin",     0x080000, 0x68CB6211, BRF_ESS | BRF_PRG }, //  1
...
struct BurnDriver BurnDrvUoPoko = {
	...
	"Uo Poko (ver. 1998 Feb 06)\0", "Japan region", "Cave / Jaleco", "Cave",
	L"\u30D1\u30BA\u30EB - \u9B5A\u30DD\u30B3 (ver. 1998 Feb 06)\0Uo Poko\0", NULL, NULL, NULL,
