...
static int DrvInit()
{
	...
	if (!strcmp(BurnDrvGetTextA(DRV_NAME), "s1945") || !strcmp(BurnDrvGetTextA(DRV_NAME), "s1945j")) {
		PsikyoHardwareVersion = PSIKYO_HW_S1945;

		CheckSleep = psikyoCheckSleep;

		if (!strcmp(BurnDrvGetTextA(DRV_NAME), "s1945j")) {
			TengaiMCUInit(s1945j_table);
		} else {
...
struct BurnDriver BurnDrvSamuraiA = {
	...
	"Samurai Aces\0", NULL, "Psikyo / Banpresto", "Psikyo 68EC020",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvSngkAce = {
	...
	"Sengoku Ace (Japan)\0", "Japan region", "Psikyo / Banpresto", "Psikyo 68EC020",
	L"\u6226\u56FD\u30A8\u30FC\u30B9\0Sengoku Ace\0", NULL, NULL, NULL,
...
static struct BurnRomInfo gunbirdkRomDesc[] = {
	...
	{ "1k-u39.bin",   0x080000, 0x669632FB, BRF_ESS | BRF_PRG }, //  1
...
struct BurnDriver BurnDrvGunbird = {
	...
	"Gunbird\0", NULL, "Psikyo", "Psikyo 68EC020",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_16BIT_ONLY, 2, HARDWARE_MISC_MISC,
...
struct BurnDriver BurnDrvGunbirdj = {
	...
	"Gunbird (Japan)\0", "Japan region", "Psikyo", "Psikyo 68EC020",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_16BIT_ONLY, 2, HARDWARE_MISC_MISC,
...
struct BurnDriver BurnDrvGunbirdk = {
	...
	"Gunbird (Korea)\0", "Korea region", "Psikyo", "Psikyo 68EC020",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_16BIT_ONLY, 2, HARDWARE_MISC_MISC,
...
struct BurnDriver BurnDrvS1945jn = {
	...
	"Strikers 1945 (gunbird hardware)\0", "Gunbird hardware, Japan region", "Psikyo", "Psikyo 68EC020",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_16BIT_ONLY, 2, HARDWARE_MISC_MISC,
...
struct BurnDriver BurnDrvS1945 = {
	...
	"Strikers 1945 (set 1)\0", NULL, "Psikyo", "Psikyo 68EC020",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_16BIT_ONLY, 2, HARDWARE_MISC_MISC,
...
struct BurnDriver BurnDrvS1945j = {
	...
	"Strikers 1945 (Japan)\0", "Japan region", "Psikyo", "Psikyo 68EC020",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_16BIT_ONLY, 2, HARDWARE_MISC_MISC,
...
struct BurnDriver BurnDrvS1945a = {
	...
	"Strikers 1945 (set 2)\0",NULL,"Psikyo", "Psikyo 68EC020",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_16BIT_ONLY, 2, HARDWARE_MISC_MISC,
	NULL, s1945aRomInfo, s1945aRomName, gunbirdInputInfo, s1945WorldDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &PsikyoRecalcPalette,
	224, 320, 3, 4
};
...
static struct BurnRomInfo tengaiRomDesc[] = {
	...
	{ "3-u63.bin",    0x020000, 0x2025E387, BRF_ESS | BRF_PRG }, //  7 CPU #1 code
