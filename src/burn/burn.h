...
// ---------------------------------------------------------------------------
//patch.cpp (add by emufan)
extern bool bDoPatch;
extern int nPatchIndex;
...
extern void ConstructComboList();
extern void ProcessCombo();
extern void ResetComboList();
...
#define HARDWARE_PREFIX_CAPCOM2		(0x07000000)
...
#define HARDWARE_CAPCOM_CPS2		(HARDWARE_PREFIX_CAPCOM2 | 0x00050000)
...
#define HARDWARE_SEGA_SHARRIER		(HARDWARE_PREFIX_SEGA | 0x00070000)
...
#define HARDWARE_SNK_PVC_PROTECTION	(0x0300)	// PVC protection
...
#define HARDWARE_SNK_PCB_BIOS 		(0x6000)	// Uses custom BIOS
